...
const defaultAchievements = [
  ...
  { label: "AWARDS AND HONORS", value: "28" },
];

const About = ({
  title = "Who We Are",
  description = "Osei Prempei is your reliable partnmer on the path to legal success. Whether you require assistance with business law, family law, estate planning, or any other legal matter",
  mainImage = {
  ...
  breakout = {
    ...
    alt: "logo",
    title: "We uphold the highest standards of integrity",
    description:
  ...
  achievementsDescription = "Providing clients with effective tools to improve workflows, boost efficiency, and encourage growth.",
